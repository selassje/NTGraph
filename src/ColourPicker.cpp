...
LRESULT CColourPicker::OnSelEndOK(WPARAM wParam, LPARAM /*wParam*/)
{
...
LRESULT CColourPicker::OnSelEndCancel(WPARAM wParam, LPARAM /*wParam*/)
{
    m_bActive = FALSE;
...
LRESULT CColourPicker::OnSelChange(WPARAM wParam, LPARAM /*wParam*/)
{
